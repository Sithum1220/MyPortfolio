...
function focusNextTextFeild() {
    S('#customerId,#customerName,#customerMobile,#customerCity,#customerStreet,#customerNIC').on('keydown keyup', function (event) {
        if (event.key == "Tab") {
        ...
        if (event.key == "Enter") {
            ...
            if (S('#customerName').val() != "") {
                S('#customerMobile').focus();
            }

            if (S('#customerMobile').val() != "") {
                S('#customerNIC').focus();
            }

            if (S('#customerNIC').val() != "") {
                S('#customerCity').focus();
            }

            if (S('#customerCity').val() != "") {
